...
def getparser():
    ...
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[30,100,290,500,600,700,1_000,15_00,2_000,2020,2040,2060,2080,2500,3_000,3_500,4_000,5_000,6_000,7_000, 10000, 12000, 15_000,20_000,23_000,25_000, 28_000,30_000])

    parser.add_argument("--test_iteration", default=-1, type=int)
    parser.add_argument("--reload_iteration", default=-1, type=int)
