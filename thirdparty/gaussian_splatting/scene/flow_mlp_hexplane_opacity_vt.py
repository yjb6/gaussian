...
#            new_trbf_center.append(torch.rand(1).cuda() * torch.ones((Npoints, 1), device="cuda")) 
    ...
    def get_deformation(self,timestamp):
        ...
        trbfdistanceoffset = timestamp  - self._trbf_center #时间间隔[N,1]
        ...
        start_t = self._trbf_center + point_dt/2
        ...
        hexplane_feature = self.hexplane(xyz_repeat,t_valid_values.unsqueeze(1)) #[N,D]
        ...
        if self.args.dx:
            ...
            motion_residual = motion_residual*point_dt_repeat
        ...
        if self.args.dopacity:
            ...
            opacity_residual = opacity_residual*point_dt_repeat
