...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians, load_iteration=None, shuffle=True, resolution_scales=[1.0], multiview=False,duration=50.0, loader="colmap"):
        ...
        elif loader == "hypernerf" or  loader == "hypernerfvalid":
    ...
    def save(self, iteration):
        save_path = os.path.join(self.model_path, "point_cloud/iteration_{}.pth".format(iteration))
        mkdir_p(os.path.dirname(save_path))
        torch.save((self.gaussians.capture(), iteration), save_path)
