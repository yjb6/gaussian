...
class GaussianModel:
    ...
    def save_ply(self, path):
        ...
        attributes = np.concatenate((xyz, normals, motion, motion_fourier, f_dc, opacities, scale, rotation, omega), axis=1)
    ...
    def densification_postfix(self, new_xyz, new_features_dc, new_opacities, new_scaling, new_rotation, new_motion, new_motion_fourier,new_omega, dummy=None):
        d = {"xyz": new_xyz,
    ...
    def densify_and_splitv2(self, grads, grad_threshold, scene_extent, N=2):
        ...
        self.densification_postfix(new_xyz, new_features_dc, new_opacity, new_scaling, new_rotation,  new_motion, new_motion_fourier, new_omega)
    ...
    def densify_and_clone(self, grads, grad_threshold, scene_extent):
        ...
        self.densification_postfix(new_xyz, new_features_dc, new_opacities, new_scaling, new_rotation,  new_motion, new_motion_fourier, new_omega)
