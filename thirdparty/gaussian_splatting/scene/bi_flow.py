...
class GaussianModel:
    ...
    def __init__(self, args,order =16 , rgbfunction="rgbv1"):
        ...
        hexplane_outdim = self.forward_field.feat_dim
    ...
    def save_ply(self, path):
        ...
        'forward_state_dict':self.forward_field.state_dict(),"opacity_state_dict":self.opacity_mlp.state_dict(),
        'backward_state_dict':self.backward_field.state_dict()}
        if self.args.dsh:
    ...
    def densify_pruneclone(self, max_grad, min_opacity, extent, max_screen_size, splitN=1):
        ...
        if max_screen_size:
            big_points_vs = self.max_radii2D > max_screen_size  #[N,K]
...
#            new_trbf_center.append(torch.rand(1).cuda() * torch.ones((Npoints, 1), device="cuda")) 
    ...
    def set_bounds(self,xyz_max, xyz_min):
        ...
        self.forward_field.set_aabb(xyz_max,xyz_min,self.duration   )
