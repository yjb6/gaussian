...
def train_ours_flow_mlp_opacity(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None, basicfunction = None, GRsetting=None, GRzer=None, stage=None):
    """
    Render the scene. 
    基本完全参照gs-flow的实现
    """
